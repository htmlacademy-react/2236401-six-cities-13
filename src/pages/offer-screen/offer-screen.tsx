...
function OfferScreen({offers, reviews}: OfferScreenProps): JSX.Element {
  ...
  const {isPremium, title, rating, price, images, type, bedrooms, maxAdults, goods, host, description} = currentOffer;
  ...
  return (
    <div className="page">
      <Helmet>
        <title>Six cities. Find the latest travel news and offers.</title>
      </Helmet>
